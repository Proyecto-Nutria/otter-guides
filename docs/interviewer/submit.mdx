...
according to [playwright docs](https://playwright.dev/docs/interviewer/installation/)
:::
...
in <a href={"/docs/interviewer/configuration#languageslangaliases-objectonlinejudgename-string"} style={{color: 'white'}}>`languages.cpp.aliases.codeforces`</a>
like this:
...
See [Add Online Judge Support](/docs/interviewer/add-online-judge-support) for guidance on how to do it.
:::
