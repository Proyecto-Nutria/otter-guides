...
"[How to add an editor](/docs/interviewer/add-editor-support)"
...
Visit the section "[How to add an editor](/docs/interviewer/add-editor-support)" if you wish to contribute and add support
...
for other languages visit the section "[How to add a language](/docs/interviewer/add-language-support)".
:::
...
- [CompetitiveProgrammingTemplate.cpp](https://gitlab.com/searleser97/competitive-programming-reference/-/blob/master/Reference/Coding%20Resources/C++/Competitive%20Programming%20Template.cpp)
  - This template allows you to print anything like in python with a `debug` function that just works when `debugCommand` is used. See [Debug](/docs/interviewer/debug) section.
...
be used instead of the default name (same as source file). See [**Test**](/docs/interviewer/test) section.
...
Visit the [**Debug**](/docs/interviewer/debug) section to see usage examples of this feature.
:::

### `languages.<lang>.aliases: Object<OnlineJudgeName, string>`

Language "aliases" for each OnlineJudge. See [How To Configure Language Aliases](/docs/interviewer/submit#how-to-configure-language-aliases).
