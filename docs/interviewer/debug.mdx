...
flags (<a href={"/docs/interviewer/configuration#languageslangdebugcommand-string"} style={{color: 'white'}}>`languages.<lang>.debugCommand`</a>).
...
you can specify it in your <a href={"/docs/interviewer/configuration#languageslangdebugcommand-string"} style={{color: 'white'}}>`languages.<lang>.debugCommand`</a>.
...
:::note
The only difference between the command used to [Test With A Single Test Case](/docs/interviewer/test#test-with-a-single-test-case) and this one, is the
...
in <a href={"/docs/interviewer/configuration#languageslangdebugcommand-string"} style={{color: 'white'}}>`languages.<lang>.debugCommand`</a>.
:::
...
You can use the following [debug command](/docs/interviewer/configuration#languageslangdebugcommand-string) to get much better feedback in case of runtime errors.
